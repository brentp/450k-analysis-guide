...
The [minfi paper](http://www.ncbi.nlm.nih.gov/pubmed/24478339) introduces stratified quantile normalization, available as `preprocessQuantile` which may also be a good alternative. But, that paper shows how small the differences in normalization methods really are. The same group has also developed [`preprocessFunnorm`](http://biorxiv.org/content/biorxiv/early/2014/02/23/002956.full.pdf) which uses control probes in a way that can also mediate batch effects....
